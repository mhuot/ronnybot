...
onmsbot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running onmsbot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start onmsbot locally by running:
...
Then you can interact with onmsbot by typing `onmsbot help`.

    onmsbot> onmsbot help
    onmsbot animate me <query> - The same thing as `image me`, except adds [snip]
    onmsbot help - Displays all of the help commands that onmsbot knows about.
    ...
